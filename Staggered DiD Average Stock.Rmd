...
# Save figure as PNG
png("carbon_credit_heterogeneity.png", width = 1200, height = 500)  # Adjust width/height as needed

grid.arrange(
  plot1, plot2, plot3,  # Replace these with your actual ggplot objects
  ncol = 3,
