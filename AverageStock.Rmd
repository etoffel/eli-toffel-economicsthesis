...
staggered_stock_did <- feols(Avg_Stock_Price ~ sunab(Year.y, Year.x) | 
                               Unique_ID + Year.x, 
                             data = merged_data3)
...
## Average Stock Price DiD
staggered_did <- feols(Avg_Stock_Price ~ sunab(Year.y, Year.x) | Unique_ID + Year.x, 
                       data = stock_with_rep)
summary(staggered_did)

iplot(staggered_did, main = "Staggered DiD: Average Stock Price", xlab = "Years Since Pledge")
```
