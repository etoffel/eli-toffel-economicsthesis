...
The project consists of two essential elements: data collection and analysis. Initially, a sample of the "most visible" companies was scraped from the Axios Harris Poll 100 from 2019-2024 using web scraping techniques. Stock data from public companies was scraped from Macrotrends, and media data was scraped from Nexis Uni searches. Lastly, carbon-neutral pledge data was collected from Carbon Neutral Tracker. 98 companies appeared in the Axios Harris Poll for more than one year that were also listed in the carbon neutral tracker dataset. Media data was scraped for the 98 companies, and stock data was scraped for all the public companies, which were 80 of the 98. These scraped datasets were inputted into R under 'Data/Build 2'. Raw data for the original Axios Harris Poll scrape and Carbon Neutral tracker are listed under 'Data/raw'. The collected data was then merged to create a unified dataset for analysis. 
