...
pacman::p_load(tidyverse,modelsummary,pandoc,dplyr,fuzzyjoin,stringr,broom,ggplot2,lubridate,tidygeocoder,plm, tigris, sf, fixest, prettymapr, ggspatial, knitr, kableExtra)
